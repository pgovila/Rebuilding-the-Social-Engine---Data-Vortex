...
-- Data Vortex Competition - Aaruush '26, Round 1
-- =============================================================================
-- Selected Questions:
--   E2 (EASY)   - Most Engaged Posts
--   M5 (MEDIUM) - Detect Suspicious Engagement
--   H5 (HARD)   - Identify Data Anomalies
-- =============================================================================
-- Schema:
--   users (user_id, location, language, followers)
--   posts (post_id, user_id, platform, text_content, likes, shares, comments)
-- =============================================================================
...
-- NOTE: This query should be run against the RAW corrupted source
--        data to detect all original anomalies before cleaning.
-- =====================================================================
...
-- =====================================================================
-- Provides a roll-up view of anomaly counts by category for
-- the Phase 2 Insight Report diagnostics section.
-- =====================================================================
